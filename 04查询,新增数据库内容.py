...
# sql2 = "insert into cmdb_host_process values (111113,666,'03test.py','03test.py',3,1,1,1,1,0,'aa','bb',to_date('2018-11-01','yyyy-mm-dd'),to_date('2018-11-01','yyyy-mm-dd'))"
       # "(111114,666,'02test.py','02test.py',2,2,2,2,2,4,'aaa','bbb',to_date('2018-11-01','yyyy-mm-dd'),to_date('2018-11-01','yyyy-mm-dd'))"
# cursor.execute(sql1)
# cursor.execute(sql2)


sql3 = 'delete * from process_info'
cursor.execute(sql3)
